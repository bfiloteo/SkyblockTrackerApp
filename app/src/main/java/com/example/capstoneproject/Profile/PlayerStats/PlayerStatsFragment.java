...
public class PlayerStatsFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<List<PlayerStats>> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new PlayerStatsAdapter(getActivity(), new ArrayList<>());
    ...
    @Override
    public Loader<List<PlayerStats>> onCreateLoader(int i, Bundle bundle) {
        // Create a new loader for the given URL
        Uri baseUri = Uri.parse(PROFILE_REQUEST_API_WITH_USERNAME);
        Uri.Builder uriBuilder = baseUri.buildUpon();
        return new PlayerStatsLoader(getActivity(), uriBuilder.toString());
    }

    @Override
    public void onLoadFinished(Loader<List<PlayerStats>> loader, List<PlayerStats> stats) {
