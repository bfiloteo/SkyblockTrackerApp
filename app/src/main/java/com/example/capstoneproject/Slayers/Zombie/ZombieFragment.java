...
public class ZombieFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<List<Zombie>> {


    public ZombieFragment() {
    }

    public static String username = "";

    private String ZOMBIE_REQUEST_API = "https://sky.shiiyu.moe/api/v2/slayers/";

    private String ZOMBIE_REQUEST_API_WITH_USERNAME = null;

    private static final int ZOMBIE_LOADER_ID = 1;

    private ZombieAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ZOMBIE_REQUEST_API_WITH_USERNAME = (ZOMBIE_REQUEST_API + retrieveUsername);
        ...
        // Create a new adapter that takes an empty list of Zombie Stats as input
        mAdapter = new ZombieAdapter(getActivity(), new ArrayList<>());
    ...
    public void createOrRefreshLoaders() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            loaderManager.initLoader(ZOMBIE_LOADER_ID, null, this);
        } else {
    ...
    @Override
    public Loader<List<Zombie>> onCreateLoader(int i, Bundle bundle) {
        // Create a new loader for the given URL
        Uri baseUri = Uri.parse(ZOMBIE_REQUEST_API_WITH_USERNAME);
        Uri.Builder uriBuilder = baseUri.buildUpon();
        return new ZombieLoader(getActivity(), uriBuilder.toString());
    }

    @Override
    public void onLoadFinished(Loader<List<Zombie>> loader, List<Zombie> stats) {
    ...
    @Override
    public void onLoaderReset(Loader<List<Zombie>> loader) {
