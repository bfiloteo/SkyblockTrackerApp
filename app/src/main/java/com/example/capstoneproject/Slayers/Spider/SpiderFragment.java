...
public class SpiderFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<List<Spider>> {
    ...
    private String SPIDER_REQUEST_API = "https://sky.shiiyu.moe/api/v2/slayers/";

    private String SPIDER_REQUEST_API_WITH_USERNAME = null;

    private static final int SPIDER_LOADER_ID = 1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SPIDER_REQUEST_API_WITH_USERNAME = (SPIDER_REQUEST_API + retrieveUsername);
        ...
        // Create a new adapter that takes an empty list of Spider Stats as input
        mAdapter = new SpiderAdapter(getActivity(), new ArrayList<>());
    ...
    public void createOrRefreshLoaders() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            loaderManager.initLoader(SPIDER_LOADER_ID, null, this);
        } else {
    ...
    @Override
    public Loader<List<Spider>> onCreateLoader(int i, Bundle bundle) {
        // Create a new loader for the given URL
        Uri baseUri = Uri.parse(SPIDER_REQUEST_API_WITH_USERNAME);
        Uri.Builder uriBuilder = baseUri.buildUpon();
        return new SpiderLoader(getActivity(), uriBuilder.toString());
    }

    @Override
    public void onLoadFinished(Loader<List<Spider>> loader, List<Spider> stats) {
    ...
    @Override
    public void onLoaderReset(Loader<List<Spider>> loader) {
