...
public class WolfFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<List<Wolf>> {
    ...
    private String WOLF_REQUEST_API = "https://sky.shiiyu.moe/api/v2/slayers/";

    private String WOLF_REQUEST_API_WITH_USERNAME = null;

    private static final int WOLF_LOADER_ID = 1;

    private WolfAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WOLF_REQUEST_API_WITH_USERNAME = (WOLF_REQUEST_API + retrieveUsername);
        ...
        // Create a new adapter that takes an empty list of Wolf Stats as input
        mAdapter = new WolfAdapter(getActivity(), new ArrayList<>());
    ...
    public void createOrRefreshLoaders() {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            loaderManager.initLoader(WOLF_LOADER_ID, null, this);
        } else {
    ...
    @Override
    public Loader<List<Wolf>> onCreateLoader(int i, Bundle bundle) {
        // Create a new loader for the given URL
        Uri baseUri = Uri.parse(WOLF_REQUEST_API_WITH_USERNAME);
        Uri.Builder uriBuilder = baseUri.buildUpon();
        return new WolfLoader(getActivity(), uriBuilder.toString());
    }

    @Override
    public void onLoadFinished(Loader<List<Wolf>> loader, List<Wolf> stats) {
    ...
    @Override
    public void onLoaderReset(Loader<List<Wolf>> loader) {
