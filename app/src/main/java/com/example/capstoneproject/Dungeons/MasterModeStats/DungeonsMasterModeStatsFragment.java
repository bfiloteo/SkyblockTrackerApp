...
public class DungeonsMasterModeStatsFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<List<DungeonsMasterModeStats>> {


    public DungeonsMasterModeStatsFragment() {
    }

    // String to hold the player's username
    public static String username = "";

    // Dungeons API link
    private String DUNGEONS_REQUEST_API = "https://sky.shiiyu.moe/api/v2/dungeons/";

    // A string that holds both the API link and the inputted username.
    ...
    private DungeonsMasterModeAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new DungeonsMasterModeAdapter(getActivity(), new ArrayList<>());
    ...
    @Override
    public Loader<List<DungeonsMasterModeStats>> onCreateLoader(int i, Bundle bundle) {
        // Create a new loader for the given URL
        Uri baseUri = Uri.parse(DUNGEON_REQUEST_API_WITH_USERNAME);
        Uri.Builder uriBuilder = baseUri.buildUpon();
        return new DungeonsMasterModeLoader(getActivity(), uriBuilder.toString());
    }

    @Override
    public void onLoadFinished(Loader<List<DungeonsMasterModeStats>> loader, List<DungeonsMasterModeStats> stats) {
    ...
    @Override
    public void onLoaderReset(Loader<List<DungeonsMasterModeStats>> loader) {
