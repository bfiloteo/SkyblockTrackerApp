...
public class DungeonClassesFragment extends Fragment
        implements LoaderManager.LoaderCallbacks<List<DungeonClasses>> {


    public DungeonClassesFragment() {
    }
    ...
    private DungeonClassesAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new DungeonClassesAdapter(getActivity(), new ArrayList<>());
    ...
    @Override
    public Loader<List<DungeonClasses>> onCreateLoader(int i, Bundle bundle) {
        // Create a new loader for the given URL
        Uri baseUri = Uri.parse(DUNGEON_REQUEST_API_WITH_USERNAME);
        Uri.Builder uriBuilder = baseUri.buildUpon();
        return new DungeonClassesLoader(getActivity(), uriBuilder.toString());
    }

    @Override
    public void onLoadFinished(Loader<List<DungeonClasses>> loader, List<DungeonClasses> stats) {
    ...
    @Override
    public void onLoaderReset(Loader<List<DungeonClasses>> loader) {
